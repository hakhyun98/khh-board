...
public class BoardEntity extends BaseEntity{
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "b202112055_board_seq_gen")
    @SequenceGenerator(sequenceName = "b202112055_board_seq", name = "b202112055_board_seq_gen", initialValue = 1, allocationSize = 1)
