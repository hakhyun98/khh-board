...
//    List<MemberEntity> getMemberEntitiesByEmailLike(@Param("email") String email);
//
//    List<MemberEntity> getMemberEntitiesByEmailContaining(@Param("email") String email);
//    List<MemberEntity> getMemberEntitiesByEmailOOrderBySeqDesc(@Param("email") String email);
}
